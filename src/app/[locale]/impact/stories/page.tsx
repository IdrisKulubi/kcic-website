...
const stories = [
  {
    ...
    description: 'SolarTech Kenya has revolutionized access to clean energy in rural communities by developing affordable solar home systems with mobile payment integration.',
    fullStory: 'Starting as a small pilot project in 2019, SolarTech Kenya has grown into one of the leading solar energy providers in East Africa. Through KCIC\'s incubation programme, founder Jane Wanjiku developed a unique business model that combines affordable solar technology with innovative financing options. Today, the company serves over 50 rural communities, providing clean energy access to more than 10,000 households.',
    achievements: [
    ...
    quote: 'KCIC provided the perfect platform to transform our idea into a scalable business. Their mentorship and network connections were invaluable in our journey.',
    tags: ['Solar Energy', 'Rural Development', 'Financial Inclusion', 'Climate Impact']
  },
  {
    id: 2,
    ...
    description: 'AgroTech Solutions uses IoT sensors and mobile technology to help smallholder farmers optimize crop yields while reducing water usage and chemical inputs.',
    fullStory: 'David Kimani\'s journey began when he witnessed his family\'s farm struggling with unpredictable weather patterns and declining productivity. Through KCIC\'s acceleration programme, he developed a comprehensive digital farming platform that provides real-time soil monitoring, weather predictions, and personalized farming advice. The solution has helped thousands of farmers increase their yields by up to 40% while reducing water consumption by 30%.',
    achievements: [
    ...
    quote: 'The technical assistance and market linkages from KCIC helped us scale our solution across multiple counties. We\'re now making a real difference in food security.',
  ...
  },
  {
    ...
    quote: 'KCIC\'s sector expertise in waste management was crucial in helping us refine our technology and connect with key stakeholders in the construction industry.',
    tags: ['Circular Economy', 'Plastic Recycling', 'Construction Materials', 'Job Creation']
  },
  {
    id: 4,
    ...
    description: 'CleanWater Innovations developed low-cost water purification systems powered by solar energy, providing safe drinking water to underserved communities.',
    fullStory: 'Inspired by his community\'s struggle with waterborne diseases, Peter Ochieng created an innovative solar-powered water purification system. Through KCIC\'s incubation programme, he refined the technology and developed a sustainable business model. The company now operates 150 water kiosks across Western Kenya, providing clean water access to over 25,000 people daily.',
    achievements: [
    ...
    quote: 'The mentorship and technical support from KCIC helped us overcome critical challenges in product development and market entry. We couldn\'t have succeeded without them.',
    tags: ['Water Purification', 'Solar Power', 'Public Health', 'Community Impact']
  },
  {
    id: 5,
    ...
    description: 'EcoTransport Kenya is transforming urban mobility with electric motorcycles and bikes, reducing emissions while providing affordable transportation solutions.',
    fullStory: 'Grace Njeri launched EcoTransport Kenya to address Nairobi\'s air pollution and traffic congestion challenges. With KCIC\'s acceleration support, she developed a comprehensive electric mobility ecosystem including vehicle manufacturing, charging infrastructure, and financing solutions. The company has deployed over 500 electric vehicles and established 50 charging stations across the city.',
    achievements: [
    ...
    quote: 'KCIC\'s network opened doors to investors and partners that were crucial for scaling our electric mobility solutions. Their support was transformational for our business.',
    tags: ['Electric Vehicles', 'Urban Mobility', 'Clean Transport', 'Infrastructure']
  }
];

const sectors = ['All', 'Renewable Energy', 'Sustainable Agriculture', 'Waste Management', 'Water & Sanitation', 'Green Transportation'];
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">{story.founder}</p>
                      <p className="text-sm text-gray-600">Founder, {story.company}</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-6">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-green-600">{story.impact.jobs}</div>
                      <div className="text-xs text-gray-600">Jobs Created</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-blue-600">{story.impact.investment}</div>
                      <div className="text-xs text-gray-600">Investment</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-purple-600">
                        {story.impact.communities || story.impact.farmers || story.impact.waste || story.impact.people || story.impact.vehicles}
                      </div>
                      <div className="text-xs text-gray-600">
                        {story.impact.communities ? 'Communities' : 
                         story.impact.farmers ? 'Farmers' :
                         story.impact.waste ? 'Waste/Month' :
                         story.impact.people ? 'People Served' :
                         'Vehicles'}
                      </div>
                    </div>
                  </div>
                  ...
                  {selectedStory === story.id && (
                    ...
                    >
                      <h4 className="text-lg font-semibold text-gray-900 mb-4">The Full Story</h4>
                      <p className="text-gray-700 leading-relaxed mb-6">{story.fullStory}</p>
