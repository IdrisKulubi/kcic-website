...
const focusSectors = [
  {
    ...
    icon: Sun,
    description: 'Supporting clean energy solutions including solar, wind, hydro, and biomass technologies to power Kenya\'s sustainable future.',
    color: 'yellow',
    keyAreas: [
      'Solar Home Systems',
...
export default function FocusSectorsPage() {
  ...
  const selectedSectorData = selectedSector ? focusSectors.find(sector => sector.id === selectedSector) : null;
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <div className="flex items-center mb-6 pb-6 border-b border-gray-200">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900 mb-1">{selectedSectorData.name}</h2>
