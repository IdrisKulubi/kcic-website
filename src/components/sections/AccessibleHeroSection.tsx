...
import { touchTargetUtils, colorUtils } from "@/lib/accessibility";
import {
  AccessibleHeading,
  AccessibleText,
  AccessibleContainer,
          ...
          <div className="hidden lg:block relative">
            <div className="h-96 relative">
              <div className="absolute inset-0 flex items-center justify-center opacity-20">
                <div
                  className={`w-64 h-64 border-2 border-white/30 rounded-full ${getMotionSafeClasses(
                    "animate-pulse"
                  )}`}
                />
              </div>
      ...
      {!shouldDisableAnimations() && (
        ...
        >
          ...
          >
            <AccessibleText
              as="span"
              className={`text-sm font-medium tracking-wide ${getMotionSafeClasses(
