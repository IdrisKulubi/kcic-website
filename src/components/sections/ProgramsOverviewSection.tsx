...
const PROGRAMS: ProgramCard[] = [
  ...
  },
  {
    ...
    overview: [
      "Pilot programme supporting solar-powered productive use in dairy, horticulture, and aquaculture across Kenya, Uganda, and Tanzania.",
    ],
    outcomes: [
      "Maximise economic and social benefits of solar energy access.",
      "Advance SDG 7 through clean, affordable renewable energy.",
      "Strengthen rural resilience through scaled PUSE solutions.",
    ],
    indicators: [
      "30 enterprises supported (10 per country).",
      "407+ direct jobs created; 1,200+ indirect jobs supported.",
      "23,516 new customers reached; 342,543 t CO₂e reduced.",
    ],
